...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "home.title": "Our Gallery",
    "home.subtitle": "Explore our collection of stunning photographs",
  ...
  fr: {
    ...
    "home.title": "Notre galerie",
    "home.subtitle": "Explorez notre collection de photographies magnifiques",
